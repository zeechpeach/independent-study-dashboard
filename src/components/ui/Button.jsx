...
const Button = ({ 
  ...
  const baseClasses = 'inline-flex items-center justify-center gap-2 font-medium rounded-md transition-all focus-ring disabled:opacity-60 disabled:cursor-not-allowed';
